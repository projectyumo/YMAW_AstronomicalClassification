...
class AstronomicalClassifier:
  def __init__(self):
    self.train_data = pd.read_csv('./YMAW_AstronomicalClassification/reduced_train_data.csv')
    self.train_metadata = pd.read_csv('./YMAW_AstronomicalClassification/reduced_train_metadata.csv')
